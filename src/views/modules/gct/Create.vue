<template>
  <div>
    ...
    <select class="form-select form-select-sm" v-model="gct.location_id" @change="updateLocation()">
    ...
    <div class="mt-3">
      ...
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="1" id="c-databases" v-model="gct.databases" />
        <label class="form-check-label" for="c-databases">
          是的，我用的到数据库，我想要一个。<span>(需要
    ...
    <div class="mt-3">
      <button :disabled="creating" class="btn btn-outline-primary" @click="createServer()">
        创建服务器
      </button>
    </div>
  </div>
